...
const Ingredients = ({ speed = 200, initialDelay = 2000 }) => {  // earlier initialDelay was 3800
  const text  = getFormattedTextArray();
  ...
  return (
    <motion.div className='mx-2 my-4' initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
